...
import com.example.example.Methodology
...
data class TimetableGroup(
    ...
    @SerializedName("school"                    ) var school                 : TimetableSchool?               = TimetableSchool(),
    @SerializedName("abonements"                ) var abonements             : ArrayList<TimetableAbonements> = arrayListOf()
)
