...
data class TimetableAbonements(
    ...
    @SerializedName("realdata"          ) var realdata        : TimetableRealdata? = TimetableRealdata(),
    @SerializedName("type"              ) var type            : TimetableType?     = TimetableType(),
    @SerializedName("child"             ) var child           : TimetableChild?    = TimetableChild(),
